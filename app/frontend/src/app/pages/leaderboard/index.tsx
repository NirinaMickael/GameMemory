        ...
        <Card className="backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 border-0 shadow-xl">
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-600 dark:text-gray-400">Aucun score enregistré pour le moment.</p>
                <Button onClick={() => router.push("/")} className="mt-4 bg-gradient-to-r from-purple-600 to-blue-600">
                  Jouer maintenant
                </Button>
              </div>
            ) : (
              <div className="space-y-3">
                {scores.map((score, index) => (
                  <div
                    key={score.id}
                    className={`flex items-center justify-between p-4 rounded-lg transition-colors ${index < 3
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <Badge variant={score.mode === "solo" ? "secondary" : "default"} className="text-xs">
                            {score.mode === "solo" ? (
                              <>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {formatTime(score.duration)} • {score.theme} • {score.grid_size}
